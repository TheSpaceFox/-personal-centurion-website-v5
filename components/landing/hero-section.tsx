...
export function HeroSection() {
  ...
  return (
    <section className="relative flex flex-col overflow-hidden">
      ...
      <div className="relative min-h-screen flex flex-col justify-center">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto w-full px-6 lg:px-12 py-32 lg:py-40">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-end">
            ...
            >
              For those who have built empires and guard their legacy with care.
              An AI that answers only to you&mdash;private, sovereign, and loyal.
            </p>
      ...
      {/* Stats marquee — below the globe viewport for clearer reading */}
      <div
