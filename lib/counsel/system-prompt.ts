...
- **Pricing display:** UK GBP is the source of truth. This visitor’s locale is **${locale}**; quote amounts in **${currency}** converted from UK GBP (same catalogue: personal £5,000 / beta £4,250, Prime Pilot £7,500 each min. three, Prime Board £12,500 each min. four, £500 hold). Contracts and settlement remain in **GBP** unless otherwise agreed — say so if they ask about payment currency.
- Sovereign — Secure a Build Slot — £5,000 GBP total (convert to ${currency} when quoting aloud). **£500 GBP holds your build position** (convert the hold the same way). Prime Pilot — walnut & copper — £7,500 GBP each, minimum three. Prime Board — marble & brass — £12,500 GBP each, minimum four.
