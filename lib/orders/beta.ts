/** July 2026 limited Beta discount — first Personal Centurion only. */
...
export const BETA_OFFER = {
  ...
  headline: '£750 off your first Personal Centurion',
  detail:
    'Limited to the first Personal Centurion purchased during the July 2026 Beta. Additional units are at the full £5,000.',
} as const
